...
// LED 클래스 /  Mouse 클래스 생성하고 적절하게 메서드 구현부를 완성하시오.
public class CentralControl {
    ...
    public void addDevice(Power device) {
        ...
        /*
            ...
            객체명.getClass().getSimpleName() -> 패키지명도 날라가고 클래스명만 반환됨
            특히 31번 라인의 경우 메서드 체이닝이라는 표현으로 자주 쓰입니다.
         */
    }
    ...
    private int checkEmpty() {   // 비어있는 배열의 index number를 반환하기 위한 method
        ...
        /*
            ...
            음수를 지정하는 경우도 있는데,
            나중에 addDevice()메서드에 if(checkEmpty() == -128047)로 쓰고 싶지 않다면
            -1을 쓰는게 정신건강에 좋습니다.
         */
    ...
    public void performSpecificMethod() {
        for(Power device : deviceArray) {
            if(device instanceof Computer) {    // 이 조건문이 true라면 해당 element는 Computer의 인스턴스
                Computer computer = (Computer) device;      // 명시적 다운캐스팅
                computer.compute();                         // 마찬가지로 computer로 다운캐스팅이 이루어져서 고유 메서드 실행 가능
