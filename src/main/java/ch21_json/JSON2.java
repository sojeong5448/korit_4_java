...
public class JSON2 {
    public static void main(String[] args) {
        ...
        // 그럼 생성된 user1 인스턴스를 가지고 Json 데이터를 바꿀겁니다.
        ...
        // 2. JsonObject -> json 으로 변환 근데 저희가 JSON1에서 했던겁니다.
        // JsonObject 를 활용하여 studentCode 2025001 / studentName 김이 / studentYear 2 / score 96.7 인 객체를 생성하시오.
        ...
        String studentJson;
        // gson 및 gsonBuilder를 이용한 studentJson을 두 번 출력한 결과값을 콘솔창에 띄울 수 있도록 하시오.
        ...
        // 3. Map -> Json 데이터로
        /*
            Map을 활용하여 key String / value String으로 선언하고, 객체명을 map1으로 한 빈 map을 생성하시오.

            map 에 productCode NT960XHA-KD72G
        ...
        // 그렇다면 json -> Map / Java 자료형으로 바꾸려면 어떡해야 할까요
