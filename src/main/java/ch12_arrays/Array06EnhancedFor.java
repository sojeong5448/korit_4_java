...
/*
    ...
    일반 for문과의 차이점 :
        ...
        그런데 잘 생각해보면 for(int i = 0; ...)으로 작성할 때 int i 는 for문의 내부에서 선업됩니다.
        (일종의 지역변수라고 볼 수 있습니다)
...
//        }
        ...
        // printElem(배열) 형태로 메서드를 정의하시오. -> int배열과 String 배열에 다 사용할 수 있도록 method overloading도 적용하시오.
...
//        }
        for(int nember : numbers) {
            System.out.print(nember + " ");
        }
    }
}
