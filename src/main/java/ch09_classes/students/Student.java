...
/*
    ...
    3. int 매개 변수를 가지는 매개변수 생성자를 정의하고
        "int 매개변수 생성자로 객체가 생성되었습니다."라고 출력

    4. String 매개 변수를 가지는 매개변수 생성자를 정의하고
        "String 매개변수 생성자로 객체가 생성되었습니다."라고 출력

    5. studentCode / name 매개 변수를 가지는 매개변수 생성자를 정의하고
        "학번과 이름으로 학생 객체가 생성되었습니다."라고 출력

    6. studentCode / name / score를 매개 변수를 가지는 매개변수 생성자를 정의하고
